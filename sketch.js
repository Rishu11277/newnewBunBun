...
var bunnyPng, bunnyEat, start, farmStation;
...
function preload() {
  ...
  start = loadImage("startButtonBunny.png")
...
function setup() {
  ...
  bunnySprite = createSprite(width / 2 + 50, height / 1.25)
...
function draw() {
  ...
  if (switchStation == 1) {
    ...
    if (collide(fruit, bunnySprite)) {
       bunnySprite.changeAnimation(bunnyEat)
       points += 0.333333333333
       switchCount += 0.333333333333
    }

    if(collide(fruit1, bunnySprite)) {
        bunnySprite.changeAnimation(bunnyEat)
        points += 0.333333333333
        switchCount += 0.333333333333
    }

    if(collide(fruit2, bunnySprite)) {
        bunnySprite.changeAnimation(bunnyEat)
        points += 0.333333333333
        switchCount += 0.333333333333
        textSize(100)
...
function mousePressedButton() {
    startButton = createSprite(width / 2, height / 2, 100, 100)
